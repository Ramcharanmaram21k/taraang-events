        ...
        <div className="md:hidden">
          <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" aria-label="Open menu" className="hover:bg-primary-foreground/10 focus:ring-0">
            ...
            <SheetContent side="right" className="p-0 bg-primary text-primary-foreground border-l-0">
               <SheetHeader className="flex flex-row items-center justify-between p-4 border-b border-primary-foreground/20">
                 <SheetTitle>
                   <Link href="/" className="flex items-center gap-3">
                     <Image src="/logo.png" alt="Taraang Events" width={100} height={100} className="drop-shadow-lg"/>
